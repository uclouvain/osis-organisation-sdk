...
from osis_organisation_sdk import rest
from osis_organisation_sdk.configuration import Configuration
from osis_organisation_sdk.exceptions import ApiTypeError, ApiValueError, ApiException
from osis_organisation_sdk.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = EntitesApi()
        api_instance.get_entities  # this is an instance of the class Endpoint
        api_instance.get_entities()  # this invokes api_instance.get_entities.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_entities.callable or self.callable in this class
